...
public class KafkaTest {
     ...
     * --topic kafka-study-consumer --from-beginning
     */
    //发送消息，发送完后不做处理 k -> name   v -> message
    private static void sendMessageForgetResult() {
        ProducerRecord<String, String> record = new ProducerRecord<>("kafka-study", "name", "message");
