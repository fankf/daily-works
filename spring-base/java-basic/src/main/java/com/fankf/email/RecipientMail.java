...
public class RecipientMail {
    //收件人地址
    public static String recipientAddress = "fankunfeng_email@163.com";
    //收件人账户名
    public static String recipientAccount = "fankunfeng_email@163.com";
    //收件人账户密码 163/qq密码需要授权，不是登录密码
    public static String recipientPassword = "XXXX";
